...
$$Distance~from~X1~to~X2 = \sqrt{(X_2 - X_1)^2 + (Y_2 - Y_1)^2}$$

The full distance travelled from the start of the transect to any given time is then simply the cumulative sum of distances of all previous points. To this we will call $\Delta Distance_{time}$
...
$$Speed_{time} = \Delta Distance_{time} - \Delta Distance_{time - 10}$$
